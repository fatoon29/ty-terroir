 ...
 * Producer
 *
 * @ORM\Table(name="producer", indexes={@ORM\Index(name="producer_city_foreign", columns={"city"}), @ORM\Index(name="producer_image_foreign", columns={"image"})})
 * @ORM\Entity
 */
class Producer
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="legal_status", type="string", length=255, nullable=true)
     */
    private $legalStatus;
